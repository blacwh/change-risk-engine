...
Historical evaluation is local and caller-supplied. The private evaluator does
...
artifact acquisition remain owner responsibilities. Runtime schemas accept only
closed unavailable reasons and aggregate limitation categories rather than raw
errors. See [historical evaluation](docs/history-evaluation.md) and the
