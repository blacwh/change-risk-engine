...
Phase 14's offline evaluation foundation is implemented: private versioned
schemas and deterministic source-free aggregate metrics can evaluate
caller-supplied canonical results and blinded labels before any default tuning.
No real corpus is included and no scoring default has changed. See
